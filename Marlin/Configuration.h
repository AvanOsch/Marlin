...
#define STRING_CONFIG_H_AUTHOR "(AvanOsch, 1.0.2 config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ZRIB_V52
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "Appie's Printer"
 ...
 *   503 : Zonestar (Z8XM2) Heated Bed Thermistor
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // 12V Zonestar Aluminium heated bed.
  // from Z8XM2 model
  #define DEFAULT_bedKp 73.45
  #define DEFAULT_bedKi 7.73
  #define DEFAULT_bedKd 465.33
#endif // PIDTEMPBED
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 300, 100 } // ...or, set your own edit limits
#endif
 ...
 */
#define Z_MIN_PROBE_PIN 19 // (Z+)   Pin 32 is the RAMPS default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, -2, -1.5 }
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     45       // LED driving pin
